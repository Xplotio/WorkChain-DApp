...
getContractFactory(name: 'WorkChainEscrow', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.WorkChainEscrow__factory>

  getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>
getContractAt(name: 'WorkChainEscrow', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.WorkChainEscrow>

  deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'WorkChainEscrow', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.WorkChainEscrow>

  deployContract(name: 'Counter', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'WorkChainEscrow', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.WorkChainEscrow>
